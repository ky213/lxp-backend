exports.up = function(knex) {
  return knex.schema.createTable('log_activity_replies', table => {
    table
    .uuid('log_activity_reply_id').defaultTo(knex.raw('uuid_generate_v4()'))  
      .primary();
...
exports.down = function(knex) {
  return knex.schema.dropTable('log_activity_replies');
};
